      ...
      {currentProjectName && (
        ...
        >
          <div className="flex-1 min-w-0">
            <div className="text-xs text-[--text-muted] uppercase tracking-wide">当前项目</div>
            <div className="text-sm font-medium text-[--accent-hover] truncate">{currentProjectName}</div>
          </div>
